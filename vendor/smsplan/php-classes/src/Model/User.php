...
class User extends Model {
    ...
    const SESSION = "User";
    const SECRET = "SMSPlanPhp7_Secret";
    ...
    public static function setSessao($msg = "principal,,") {

        $_SESSION[User::SESSAO] = $msg;
    }

    public static function getSessao() {

        $msg = $_SESSION[User::SESSAO];
    ...
    public static function getForgot($email, $inadmin = true) {
        ...
        if (count($results) === 0) {
            ...
            if (count($results2) === 0) {
                ...
                $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da SMSPlan Store", "forgot", array(
                    "name" => $data['desperson'],
                    "link" => $link
                ));
                $mailer->send();
