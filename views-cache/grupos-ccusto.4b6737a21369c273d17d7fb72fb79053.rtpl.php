...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Centros de Custo do Grupo <?php echo htmlspecialchars( $grupo["DescGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="/grupos/<?php echo htmlspecialchars( $grupo["idGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/ccustos"><?php echo htmlspecialchars( $grupo["DescGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
        </ol>
    </section>
        ...
        <div class="row">
                        ...
                        <table id="ccustosNotRelated" class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/grupos/<?php echo htmlspecialchars( $grupo["idGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/ccustos/<?php echo htmlspecialchars( $value1["idCentroCusto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" class="btn btn-primary btn-xs pull-right"><i class="fa fa-arrow-right"></i> Adicionar</a>
                                    </td>
                                </tr>
                                <?php } ?>
            ...
            <div class="col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">C Custos no Grupo <?php echo htmlspecialchars( $grupo["DescGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
