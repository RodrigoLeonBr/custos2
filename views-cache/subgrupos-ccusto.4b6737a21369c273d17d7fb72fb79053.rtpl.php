...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Centros de Custo do SubGrupo <?php echo htmlspecialchars( $subgrupo["DescSubGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="/subgrupos/<?php echo htmlspecialchars( $subgrupo["idSubGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/ccustos"><?php echo htmlspecialchars( $subgrupo["DescSubGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <div class="box-body">
                        <table id="ccustosNotRelated" class="table table-striped table-hover">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/subgrupos/<?php echo htmlspecialchars( $subgrupo["idSubGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/ccustos/<?php echo htmlspecialchars( $value1["idCentroCusto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" class="btn btn-primary btn-xs pull-right"><i class="fa fa-arrow-right"></i> Adicionar</a>
                                    </td>
                                </tr>
                                <?php } ?>
            ...
            <div class="col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">C Custos no SubGrupo <?php echo htmlspecialchars( $subgrupo["DescSubGrupoCC"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
